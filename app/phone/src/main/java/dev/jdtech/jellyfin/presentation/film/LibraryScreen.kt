    ...
    Scaffold(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Row(
                ...
                FilterChip(
                    selected = !state.highRatedOnly,
                    onClick = { onAction(LibraryAction.SetHighRatedOnly(false)) },
                    label = { Text(stringResource(CoreR.string.filter_all)) },
                )
                FilterChip(
                    selected = state.highRatedOnly,
                    onClick = { onAction(LibraryAction.SetHighRatedOnly(true)) },
                    label = {
                        Text(
                            stringResource(
                                CoreR.string.filter_high_rated,
                                state.highRatingThreshold,
                            )
                        )
                    },
                    leadingIcon = {
